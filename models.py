...
class User(db.Model, UserMixin):
    ...
    image_file = db.Column(db.String(200), nullable=False, default='https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/1280px-Python-logo-notext.svg.png')
